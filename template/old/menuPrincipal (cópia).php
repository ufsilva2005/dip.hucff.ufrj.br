            ...
            <div class="btn-group">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="../views/pacienteEditarPesquisa.php">Pesquisar Pacientes</a></li>
                        <!--li><a class="dropdown-item" href="../views/pacientes.php">Exames Pacientes</a></!--li-->
                    </ul>
                </div>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="../views/.php"></a></li>
                    </ul>
                </div>  
                ...
                <div class="btn-group">   
                    &emsp; &emsp; &emsp;                 
                    <p class="timertext" style="font-size: 1rem; color:red">
                        LOGOUT EM:                         
                        <span class="secs"></span> MINUTOS POR INATIVIDADE
                    </p>
                </div>  
