            ...
            <div id="page-content-wrapper">
                ...
                <?php
                    if (isset($_GET["var1"])) 
                        ...
                        {
                            ?>
                            <form action="etiquetasImprimindoP.php" method="get"> 
                                <div class="row">
                                    <div class="col px-md-1 col-md-12">
                                        ...
                                        <!---->
                                        <label for="inputSuccess" class="control-label">Etiquetas Amostra</label>
                                        <input type="text" class="form-control" name="var1" value = "<?php echo $etiqueta; ?>" readonly hidden> <br>
                ...
                <script>
                    ...
                    qz.websocket.connect().then(function() {
                        ...
                        let delay = 100000;
                        window.location.href = "pacientesCadastro.php";
                    }).catch(function(err) {
                ...
                <?php
                    header("Location: ../views/etiquetasImprimir.php");     
                ?>
            </div>
         </div>
    </body>
