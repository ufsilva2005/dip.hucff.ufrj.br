            ...
            <div id="page-content-wrapper">
				...
				<div class="panel-content">
					<div class="col-md-12">																																
                                            ...
                                            <tr>
                                                ...
                                                <td class='operations'>
                                                    <div class="btn-group pull-right">
                                                        <a href="../views/relatorioPacienteVer.php?op=<?php echo $opcao?>&id=<?php echo $paciente->idPaciente; ?>" class="btn btn-small btn-outline-success">Confirmar<i class="icon-remove"></i></a>
                                                    </div>                                                    
                                                </td>                                                                                           
                                            <tr>									
                                        <?php 
                        ...
                        <div class="btn-group pull-right">
                            <a href="relatorioPaciente.php" class="btn btn-small btn-outline-warning">Voltar<i class="icon-remove"></i></a>
                        </div>  
                    </div>	
				</div>	
            </div>	
