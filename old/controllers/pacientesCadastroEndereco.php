    ...
    if( $opcao == 1 && $idPaciente == 0)
        {
            ...
            $paciente = new Paciente($idPaciente, $nomePaciente, $dataNasce, $prontuario, $gestante, $numSus, $dadosCpf, $sexo, $identidade, $orgaoEmissor, $naturalidade,
