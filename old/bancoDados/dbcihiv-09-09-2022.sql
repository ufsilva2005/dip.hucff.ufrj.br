...
--
-- Host: localhost
-- Tempo de geração: 09/09/2022 às 15:45
...
CREATE TABLE `examesSolicitados` (
  ...
  `numAmostraCega` varchar(50) DEFAULT NULL,
...
INSERT INTO `funcionario` (`idFuncionario`, `login`, `senha`, `nomeFuncionario`, `cpf`, `status`, `dataCadastro`, `idPermissoes`) VALUES
(1, 'administrador', '$2y$12$/nz/dju7PaMTU/lS16R6OOKOqBvL6WvGD1qzsZ56EW8Uvcnvdrtt.', 'administrador', 'NULL', 'ativo', NULL, 1),
(2, 'ufs', '$2y$12$OdZNMf3WJJh9B9zsmrmgyOi.xWxPb0Q85bfixKiB2sOabtEL0JvP2', 'ULISSES FERREIRA DA SILVA', '011.726.807-01', 'ativo', '2022-08-29', 2);
...
--
ALTER TABLE `permissoes`
  MODIFY `idPermissoes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
