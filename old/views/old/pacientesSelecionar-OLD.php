                                    ...
                                    { 
                                        ?>													
                                            <tr>
                                                ...
                                                <td class='operations'>
                                                    <div class="btn-group pull-right">
                                                        <a href="../controllers/pacientesCadastroEndereco.php?action=2&id=<?php echo $paciente->idPaciente;?>" class="btn btn-small btn-outline-warning">Confirmar<i class="icon-remove"></i></a>
                                                    </div>                                                    
                                                </td>                                                                                           
                                            <tr>									
                                        <?php 
