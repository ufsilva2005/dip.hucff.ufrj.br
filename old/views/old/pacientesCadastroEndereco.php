				...
				<div id="order-form-container" class="container p-6 my-md-4 px-md-0">
					<div class="col-md-12">																																
						<form  name="cadastro" id="address-form" class="form-horizontal" action="../controllers/pacientesCadastroEndereco.php?action=1&id=0" method="POST">		
                            ...
                            <div class="row">
								...
								<div class="row mb-3">
									...
									<div class="form-floating col px-md-1 col-md-4">
										<input type="text" class="form-control shadow-none" id="rua" name="rua" placeholder="Rua" />
							...
							<div class="row">							
 								<div class="form-floating col px-md-1 col-md-4">
									<input type="text" class="form-control shadow-none" id="bairro" name="bairro" placeholder="Bairro" required data-input readonly/>
									<label for="bairro">Bairro</label>
								</div>
								
								<div class="form-floating col px-md-1 col-md-4">
									<input type="text" class="form-control shadow-none" id="cidade" name="cidade" placeholder="Cidade" required data-input readonly/>
									<label for="cidade">Cidade</label>
								</div>

								<div class="form-floating col px-md-1 col-md-4">
									<input type="text" class="form-control shadow-none" id="uf" name="uf" placeholder="uf" required data-input readonly/>
