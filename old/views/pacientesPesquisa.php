...
?>
        ...
        <div class="container">
			<div class="panel-header">
				...
				<h3 class="text-success">Pesquisa por Pacientes</h3>
			</div>
			<hr>		
            <form name="cadastro" id="cadastro" class="form-horizontal" action="../controllers/pacientePesquisa.php" onsubmit="ValidarCPF(cadastro.dadosCpf);" method="POST">	
                <div class="row">
